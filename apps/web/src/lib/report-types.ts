...
export type CitationRef = { url: string; domain: string };
...
export type CoOccurrence = { brand: string; count: number };
...
export type PromptResult = { query: string; platforms: PromptPlatformCell[] };
...
export type SubScore = { label: string; score: number | null; note: string };
...
export type DayPlan = { day: number; title: string; task: string; connectedProblem: string };
export type WeekPlan = { week: number; theme: string; tasks: { task: string; connectedProblem: string }[] };
export type MonthPlan = { month: number; theme: string; tasks: string[] };
