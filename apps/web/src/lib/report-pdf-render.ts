...
function mentionRateLabel(r: IntelligenceReport): string {
...
function page2ReadAndSummary(doc: PDFDocument, font: PDFFont, bold: PDFFont, r: IntelligenceReport) {
  const page = doc.addPage([W, H]);
  paint(page);
...
function page3GoodBadMissing(doc: PDFDocument, font: PDFFont, bold: PDFFont, r: IntelligenceReport) {
  const page = doc.addPage([W, H]);
  paint(page);
...
function page4Llms(doc: PDFDocument, font: PDFFont, bold: PDFFont, r: IntelligenceReport) {
  const page = doc.addPage([W, H]);
  paint(page);
...
function page5Competition(doc: PDFDocument, font: PDFFont, bold: PDFFont, r: IntelligenceReport) {
  const page = doc.addPage([W, H]);
  paint(page);
...
function page6Better(doc: PDFDocument, font: PDFFont, bold: PDFFont, r: IntelligenceReport) {
  const page = doc.addPage([W, H]);
  paint(page);
...
function page7LlmStrategy(doc: PDFDocument, font: PDFFont, bold: PDFFont, r: IntelligenceReport) {
  const page = doc.addPage([W, H]);
  paint(page);
